...
function GameServer() {
    ...
    this.config = {
        ...
        serverMaxConnections: 50, // Maximum number of connections to the server. (0 for no limit)
        ...
        ejectSizeLoss: 0, // Eject size which will be substracted from player cell (vanilla: mass = val*val/100 = 18 mass?)
        ...
        playerStartSize: 40, // Start size of the player cell. (vanilla: mass = val*val/100 = 10 mass)
        ...
        playerMaxNickLength: 11, // Maximum nick length
